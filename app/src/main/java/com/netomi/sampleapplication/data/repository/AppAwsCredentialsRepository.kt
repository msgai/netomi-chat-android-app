...
class AppAwsCredentialsRepository private constructor(context: Context) {
    ...
    companion object {
        @Volatile
        private var INSTANCE: AppAwsCredentialsRepository? = null

        fun getInstance(context: Context): AppAwsCredentialsRepository {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: AppAwsCredentialsRepository(context.applicationContext).also { INSTANCE = it }
            }
        }
    }
}