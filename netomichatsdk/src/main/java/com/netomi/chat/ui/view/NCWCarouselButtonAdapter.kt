...
class NCWCarouselButtonAdapter(private val items: List<NCWCarouselButton>, private val carouselButton: (NCWCarouselButton?) -> Unit) : RecyclerView.Adapter<NCWCarouselButtonAdapter.ViewHolder>() {
