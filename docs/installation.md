...
2. Add the SDK to your **app module** `build.gradle(.kts)` (version `1.29.3`):
...
dependencies {
    implementation("com.netomi.chat:chat-widget-android:1.29.3")
    implementation("com.netomi.chat:chat-widget-android-analytics:1.29.3")
}
```
...
dependencies {
    implementation("com.netomi.chat:chat-widget-android:1.29.3")
    implementation("com.netomi.chat:chat-widget-android-voicestt:1.29.3")
}
```
